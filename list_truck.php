		...
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="page-header">
					<h1>Caminhões <small>todos os Caminhões cadastrados</small></h1>
				</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						<div class="panel-tools">
							<a class="btn btn-xs btn-green tooltips" href="cad_truck.php" data-original-title="Adicionar Caminhão" data-placement="top"><i class="fa fa-plus"></i></a>
