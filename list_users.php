					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Usuários Cadastrados <small>todos os usuários cadastrados</small></h1>
							</div>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									...
									<div class="panel-tools">
										<a class="btn btn-xs btn-green tooltips" href="cad_user.php" data-original-title="Cadastrar Usuário" data-placement="top"><i class="fa fa-plus"></i>
										</a>
